...
<nav class="navbar navbar-expand-lg navbar-dark bg-dark">
    ...
    <div class="collapse navbar-collapse" id="navbarSupportedContent">
        <ul class="navbar-nav mr-auto">
            <li class="nav-item">
                <a class="nav-link " href="/products?special=smartphone">Điện thoại</a>
            </li>
            <li class="nav-item">
        ...
        <form class="form-inline my-2 my-lg-0">
            ...
            <button class="btn btn-outline-success my-2 my-sm-0" name="button hear" style="width:auto;">Hear</button>
        </form>
        ...
        <div id="id01" class="modal">
            <form class="modal-content animate" action="/products?action=login" method="post">
                <div class="imgcontainer">
                    ...
                    <img src="https://image.shutterstock.com/image-photo/catboss-tie-260nw-444181159.jpg" alt="Avatar" class="avatar">
                </div>
                <div class="container">
